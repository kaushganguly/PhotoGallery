...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :--- |
| [WebApp-Storage-DotNet\WebApp-Storage-DotNet.csproj](#webapp-storage-dotnetwebapp-storage-dotnetcsproj) | net48 | 🔴 High | 33 | 0 | 14 |  | Wap, Sdk Style = False |
...
| Azure.Storage.Blobs | 12.9.1 | 12.29.0 | [WebApp-Storage-DotNet.csproj](#webapp-storage-dotnetwebapp-storage-dotnetcsproj) | NuGet package contains security vulnerability |
...
| Microsoft.Bcl.AsyncInterfaces | 1.0.0 | 10.0.8 | [WebApp-Storage-DotNet.csproj](#webapp-storage-dotnetwebapp-storage-dotnetcsproj) | NuGet package upgrade is recommended |
...
| System.Diagnostics.DiagnosticSource | 4.6.0 | 10.0.8 | [WebApp-Storage-DotNet.csproj](#webapp-storage-dotnetwebapp-storage-dotnetcsproj) | NuGet package upgrade is recommended |
...
| System.Memory.Data | 1.0.2 | 10.0.8 | [WebApp-Storage-DotNet.csproj](#webapp-storage-dotnetwebapp-storage-dotnetcsproj) | NuGet package upgrade is recommended |
...
| System.Text.Encodings.Web | 4.7.2 | 10.0.8 | [WebApp-Storage-DotNet.csproj](#webapp-storage-dotnetwebapp-storage-dotnetcsproj) | NuGet package upgrade is recommended |
| System.Text.Json | 4.6.0 | 10.0.8 | [WebApp-Storage-DotNet.csproj](#webapp-storage-dotnetwebapp-storage-dotnetcsproj) | NuGet package upgrade is recommended |
...
```mermaid
flowchart LR
    P1["<b>⚙️&nbsp;WebApp-Storage-DotNet.csproj</b><br/><small>net48</small>"]
    click P1 "#webapp-storage-dotnetwebapp-storage-dotnetcsproj"

```

## Project Details

<a id="webapp-storage-dotnetwebapp-storage-dotnetcsproj"></a>
...
```mermaid
flowchart TB
    subgraph current["WebApp-Storage-DotNet.csproj"]
        MAIN["<b>⚙️&nbsp;WebApp-Storage-DotNet.csproj</b><br/><small>net48</small>"]
        click MAIN "#webapp-storage-dotnetwebapp-storage-dotnetcsproj"
    end
...
| :--- | :---: | :--- | :--- |
| Manual redirect conflicts with auto-generated version | 🔴Mandatory | Manual redirect for Newtonsoft.Json targets 6.0.0.0 but auto-generation would target 6.0.8 (MSB3836 conflict) | Remove the conflicting manual binding redirect or disable auto-generation. |
...
| Manual redirect conflicts with auto-generated version | 🔴Mandatory | Manual redirect for System.Text.Encodings.Web targets 4.0.5.1 but auto-generation would target 4.7.2 (MSB3836 conflict) | Remove the conflicting manual binding redirect or disable auto-generation. |
| Binding redirect forces version downgrade | 🟡Potential | Binding redirect for Newtonsoft.Json targets 6.0.0.0 but package provides 6.0.8 | Update the binding redirect newVersion to match the version provided by the NuGet package. |
...
| Binding redirect forces version downgrade | 🟡Potential | Binding redirect for System.Text.Encodings.Web targets 4.0.5.1 but package provides 4.7.2 | Update the binding redirect newVersion to match the version provided by the NuGet package. |
